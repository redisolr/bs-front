        ...
        <div class="container">
            <div class="siteinfo">
                ...
                <ul class="c0">
                    ...
                    <ul>
                        <li class="c2"><a class="c3" target="_blank"
                                          href="https://github.com/redisolr/bs-service">官方开源</a></li>
                        <li class="c2"><a class="c3" target="_blank"
                                          href="https://github.com/redisolr/bs-front">项目前端</a></li>
                        <li class="c2"><a class="c3" target="_blank"
                                          href="https://github.com/redisolr/bs-manager">项目后端</a></li>
                    </ul>
                </ul>
                <!--<ul class="c0">
                    <h3 class="c1">自助服务</h3>
                    <ul>
                        ...
                        <li class="c2"><a class="c3" target="_blank" href="https://www.bilibili.com/video/av15860053/">个人视频</a>
                        </li>
                    </ul>
                </ul>-->
                <!--<ul class="c0">
                ...
                <ul class="c0">
                    ...
                    <ul>
                        <li class="c2"><a class="c3" target="_blank"
                                          href="http://wpa.qq.com/msgrd?v=3&uin=843014339&site=qq&menu=yes">腾讯 QQ</a>
                        </li>
                        <li class="c2"><a class="c3" target="_blank" href="https://gitee.com/qtxln">码云</a>
                        </li>
                        <li class="c2"><a class="c3" target="_blank" href="mailto:843014339@qq.com">官方邮箱</a></li>
                    </ul>
                </ul>

                <ul class="c4">
                    <li class="tel"><a class="c5" href="http://wpa.qq.com/msgrd?v=3&uin=843014339&site=qq&menu=yes"
                                       target="_blank">843014339</a></li>
                    <li class="online">
            ...
            <div class="copyright">
                <h4 class="content-c2">Copyright ©2018, redisolr. All Rights Reserved.本网站设计内容大部分属锤子科技</h4>
                <ul class="privacy">
                    <li class="content-c1"><a class="content-c0" @click="open1">法律声明</a></li>
                    <li class="content-c1"><a class="content-c0" @click="open2">隐私条款</a></li>
                    <li class="content-c1"><a class="content-c0" target="_blank" href="https://github.com/redisolr">开发者中心</a></li>
                </ul>
            </div>
            <div class="cop">
                <a class="content-c3" href="http://www.miibeian.gov.cn/" target="_blank">
                    <span class="content-c3">京ICP备17001595号-1</span>
                </a>
            </div>
        </div>
    </div>
