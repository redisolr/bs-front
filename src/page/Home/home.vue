    ...
    <div class="home">
        ...
        <div v-loading="loading" element-loading-text="加载中..." style="min-height: 35vw;" v-if="!error">
            <div class="banner">
                <div class="bg" ref="bg"
                    ...
                    <transition-group name="fade">
                        <div v-for="(item, i) in banner" :key="i" v-if="i===mark" style="position:absolute"
                             @click="linkTo(item)" @mouseover="stopTimer" @mouseout="startTimer">
                            <img class="img1" :src="item.pictureUrl"/>
                        </div>
                    </transition-group>
                </div>
                <div class="page">
            ...
            <div v-for="(item,i) in home" :key="i">
                ...
                <!--2图-->
                <section class="w mt30 clearfix" v-if="item.typeId === 4">
                ...
                <!--7图-->
                <section class="w mt30 clearfix" v-if="item.typeId === 2">
                    <y-shelf :title="item.panelName">
                        <div slot="content" class="floors">
                            <div class="imgbanner" v-for="(iitem,j) in item.panelContents" :key="j" v-if="j === 0"
                                 @click="linkTo(iitem)">
                                <img v-lazy="iitem.pictureUrl">
                                <a class="cover-link"></a>
                            </div>
...
<script>
import {productHome} from '../../api/manager'
...
export default {
	...
	mounted() {
		productHome().then(res => {
			...
			this.banner = data[0].panelContents;
		})
	},
	created() {
		this.play()
