        ...
        <y-shelf title="收货地址">
            ...
            <div slot="content">
                ...
                <div class="table-title">
                    <span class="name">姓名</span> <span class="address">详细地址</span> <span class="contactPhone">电话</span>
                </div>
                <div v-if="addList.length">
                    <div class="address-item" v-for="(item,i) in addList" :key="i">
                        ...
                        <div class="contactPhoneephone">{{item.contactPhone}}</div>
                        <div class="defalut">
                        ...
                        <div class="operation">
                            ...
                            <el-button type="danger" icon="delete" size="small" :data-id="item.id"
        ...
        <y-popup :open="popupOpen" @close='popupOpen=false' :title="popupTitle">
            <div slot="content" class="md" :data-id="msg.id">
                ...
                <y-button text='保存'
                          ...
                          @btnClick="save({id:msg.id,contactName:msg.contactName,contactPhone:msg.contactPhone,addressDetail:msg.addressDetail,isDefault:msg.isDefault})">
                </y-button>
            </div>
        </y-popup>
    </div>
